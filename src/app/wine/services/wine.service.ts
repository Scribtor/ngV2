...
export class WineService{
  ...
  // Ovo je property koji će da čuva ono što stigne sa servera, dok se zapravo samo property spisak
  //  menja, a na osnovu veličine ovog property-a. 
  // Ovo menja "const VINA" čiji je import zakomentarisan gore
  constructor(private wsH:ServedWineService) { 
    // this.praviListu(0,this.krajnjiID,5);
    // Zaostalo od vremena wsL-a i VAR objekata, u asinhronom svetu nema šta da radi
  }
